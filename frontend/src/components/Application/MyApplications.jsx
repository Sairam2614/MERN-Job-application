...
const MyApplications = () => {
  ...
  useEffect(() => {
    try {
      if (user && user.role === "Employer") {
        axios
          .get("https://mern-job-application-1.onrender.com/api/v1/application/employer/getall", {
        ...
        axios
          .get("https://mern-job-application-1.onrender.com/api/v1/application/jobseeker/getall", {
            withCredentials: true,
          })
          .then((res) => {
            setApplications(res.data.applications);
  ...
  const deleteApplication = (id) => {
    try {
      axios
        .delete(`https://mern-job-application-1.onrender.com/api/v1/application/delete/${id}`, {
          withCredentials: true,
        })
        .then((res) => {
